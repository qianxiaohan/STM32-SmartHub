 ...
 * 占用空间 : 13字节.
 */
#define TP_SAVE_ADDR_BASE   0X000000 
#define ADJDATA_SIZE    13 /* 校准数据的大小一共13字节：xfc, yfc, xoff, yoff, 校准标志位 flag */
...
uint8_t w25qxx_get_adjust_data(void);   /* 从FLASH获取校准参数 */
void w25qxx_save_adjust_data(void);     /* 保存校准参数到FLASH */
